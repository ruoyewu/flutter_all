...
class Widgets {
  ...
  static SnackBar defaultButtonSnackBar(
          String info, String buttonTitle, Function onTap) =>
      SnackBar(
        content: Text(info),
  ...
  static showButtonSnackBar(
      BuildContext context, String info, String buttonTitle, Function onTap) {
    Scaffold.of(context)
      ..hideCurrentSnackBar()
